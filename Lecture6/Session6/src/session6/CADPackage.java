...
public class CADPackage {
    ...
    public static void main (String [] args){
      ...
      s [0] = new Sphere(0.0,0.0,0.0,0.0,    50.0);  //centered on origin r = 50
      s [1] = new Cube(50.0,25.0,12.0,       30.5); // centered on (50,25,12) r = 30.5
      s [2] = new Cylinder(10,20,30,          50, 100); // centered around 10,20,30 , r = 50, h = 100
     ...
     shapes.add(new Sphere(0.0,0.0,0.0,0.0,    50.0));  
