...
public class DivByZero extends Exception {
  ...
  public DivByZero(){super();}
}

//package edu.stevens.ee552;   //Packages should have dots
...
//2. Implement an abstract class that supports two methods doit() and undoit.  
//Write a class InsertText that implements the two methods with doit() inserting text into a buffer and undoit removing that text.
